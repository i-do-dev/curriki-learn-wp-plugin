...
- Description usage: add description when an item needs more than a label. For framework layout, set description to a string[] of 2–4 compact phrases, each ~3–4 words (max 5) — e.g. ["Original human synthesis", "No AI shortcuts", "Lived reasoning required"]. For all other layouts, keep description to ONE short sentence (12–16 words, fits 2 lines) — never a paragraph or multiple sentences. Required in editorial; optional elsewhere. Do not pad with repetition of item.text.
