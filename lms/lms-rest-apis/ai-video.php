...
| fuel_engine        | 3-5 items — set role:'input' on ingredients (left), role:'output' on exactly 1 result (right); item.text max 3-5 words to fit the narrow input/output cards; description (if used) max 8-10 words |
