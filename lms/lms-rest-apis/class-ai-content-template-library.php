...
class TL_AI_Content_Template_Library {
  /**
   ...
   * @return string
   */
  public static function get_block_template( $type, $component_count = 0 ) {
    switch ( $type ) {
      case 'hero':
   ...
   * @return string
   */
  public static function render_preview_template( $template, $replacements ) {
   ...
   * @return string Template ID ('01' to '15'). Falls back to '01' on error.
	 */
  public static function classify_template( $lesson_title, $lesson_content ) {
   ...
   * - Uses styled <span> markers for checklist rows
	 * - Ends with a Capstone Activity section containing [Capstone Box] sentinel
	 *
   * @param  string $template_id  '01' to '15'
...
HTML;
	 ...
	 * @return string
   */
  public static function build_template_system_prompt( $lesson_title = '' ) {
	 ...
	 * @return string
   */
  public static function build_template_user_message( $lesson_content, $lesson_title, $template_html, $component_count = 0 ) {
