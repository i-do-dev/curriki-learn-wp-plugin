	...
	function feedbackViewModal($assignment_submission){
    	...
    	add_action('wp_footer', function () use ($submission_id) {
			...
			wp_enqueue_style(
				...
				TL_PLUGIN_URL . 'includes/widgets/assets/style/feedback-view-style.css',
				array(),
				'1.0'
			);
			...
			wp_enqueue_script(
				...
				TL_PLUGIN_URL . 'includes/widgets/assets/js/feedback-view-modal.js',
				array('jquery'),
				'1.0',
				true
			);
	...
	function interactiveBookGradeSummary($all_interactions, $interaction_xapis, $assignment_submission) {
		...
		add_action('wp_footer', function () use ($marks_float, $interactions_float, $progress_float) {
			...
			wp_enqueue_script(
				...
				TL_PLUGIN_URL . 'includes/widgets/assets/js/Animated-Circular-Progress-Bar-with-jQuery-Canvas-Circle-Progress/dist/circle-progress.js',
				array('jquery'),
				'1.0',
				true
			);
			...
			wp_enqueue_script(
				...
				TL_PLUGIN_URL . 'includes/widgets/assets/js/ib-custom-circular.js',
				array('jquery'),
				'1.0',
				true
			);
